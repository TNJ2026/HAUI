...
private const val CHAT_ATTACHMENT_MAX_WIDTH = 800
private const val CHAT_ATTACHMENT_MAX_BASE64_CHARS = 300 * 1024
private const val CHAT_ATTACHMENT_START_QUALITY = 75
private const val CHAT_DECODE_MAX_DIMENSION = 1600
const val CHAT_IMAGE_CACHE_BYTES = 16 * 1024 * 1024
...
fun loadSizedImageAttachment(resolver: ContentResolver, uri: Uri): PendingAttachment {
  ...
  return PendingAttachment.Image(
